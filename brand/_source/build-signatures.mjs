...
const newEmail = `<table cellpadding="0" cellspacing="0" border="0" width="560" style="border-collapse:collapse;font-family:${SANS};width:560px;max-width:560px;">
  <tr>
    <td width="114" style="padding:4px 22px 0 0;vertical-align:top;width:114px;">
      <img src="${LOGO_URL}" width="92" height="67" alt="${firm.name}"
           style="display:block;border:0;outline:none;text-decoration:none;width:92px;height:67px;">
    </td>
